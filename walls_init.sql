...
/*Data for the table `walls_comment_for_info` */
...
/*Data for the table `walls_reply_for_user_comment` */
...
/*Data for the table `walls_school` */
...
CREATE TABLE `walls_user` (
  ...
  PRIMARY KEY (`id`,`account`,`status`),
  KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='万事墙用户表';

/*Data for the table `walls_user` */

insert  into `walls_user`(`id`,`account`,`password`,`salt`,`create_time`,`update_time`,`status`) values (1,'aaaaaa','','',0,NULL,0);
...
/*Data for the table `walls_user_info` */
...
/*Data for the table `walls_user_school` */
